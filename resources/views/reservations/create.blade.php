...
@section('content')
    <div class="container">
        ...
        <form class="text-light" action="{{ route('reservations.store') }}" method="POST">
            ...
            <input type="text"
                class="form-control" name="player_name" id="player_name" aria-describedby="helpId" placeholder="">
            </div>

            <div class="form-group mt-3">
            <label for="player_surname">Přijmení:</label>
            <input type="text"
                class="form-control" name="player_surname" id="player_surname" aria-describedby="helpId" placeholder="">
            </div>
